                ...
                <div class="card">
                    ...
                    <div class="card-body">
                                ...
                                <?php foreach ($data as $item => $keyy) : ?>
                                    <?php if($edit): 
                                        if($detail['package_id']==$keyy['id']): ?>
                                            <option selected data-price="<?= esc($keyy['price']); ?>" data-day="<?= esc($keyy['day']); ?>" data-capacity="<?= esc($keyy['min_capacity']); ?>" value="<?= esc($detail['package_id']); ?>" ><?= esc($keyy['name']); ?></option>                                                                
                                        <?php endif; ?>
                                    <?php else: ?>
                                        <option data-price="<?= esc($keyy['price']); ?>" data-day="<?= esc($keyy['day']); ?>" data-capacity="<?= esc($keyy['min_capacity']); ?>" value="<?= esc($keyy['id']); ?>" ><?= esc($keyy['name']); ?></option>                                                                
                                    <?php endif; ?>
                                <?php endforeach; ?>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" id="total_people" name="total_people" value="<?= ($edit) ? $detail['total_people'] : old('total_people'); ?>" class="form-control" min="1">
                        </div>
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-md-5">
                                ...
                                <input type="time" id="time_check_in" name="time_check_in" class="form-control">
                            </div>
                        </div>
                        ...
                        <div class="row g-4">
                            <div class="col-md-7">
                                ...
                                <input readonly type="date" id="check_out" name="check_out" class="form-control">
                            </div>
                            <div class="col-md-5">
                                <label for="check_out"></label>
                                <input readonly type="time" id="time_check_out" name="time_check_out" class="form-control">
                            </div>
                        </div>
