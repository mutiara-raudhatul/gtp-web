<div class="d-grid gap-2">
    <button type="button" class="btn btn-outline-primary" data-bs-toggle="modal" data-bs-target="#gallery" <?= (count($data[0]['gallery']) == 0) ? 'disabled' : ''; ?>>
                        ...
                        <div class="carousel-inner">
                            ...
                            <?php foreach ($data[0]['gallery'] as $g) : ?>
                                <div class="carousel-item<?= ($i == 0) ? ' active' : ''; ?>">
                                    <img src="<?= base_url('media/photos/' . $folder . '/' . esc($g)); ?>" class="d-block w-100">
                                </div>
                                <?php $i++; ?>
                            <?php endforeach; ?>
                        </div>
